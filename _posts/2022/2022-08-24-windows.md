...
### Windows配置
  ...
  - 设置支持UTF-8
    - 设置 - 时间和语言 - 左侧选择语言 - 相关设置下的管理语言设置  - 更改系统区域设置  - 勾选：Beta版：使用Unicode UTF-8提供全球语言支持
  - 关闭快速启动
...
<!-- - 关闭 Connected User Experiences and Telemetry 服务
  ...
  - 定时关机
    ...
    - 右键我的电脑 - 管理 - 任务计划程序 - 任务计划程序库 - 创建基本任务 - 触发器选“每天”切设置自动关机时间 - 操作步骤选择“启动程序” - 输入“shutdown -s”
  - 关闭繁体切换热键
  ...
  - 为实时安全中心排除文件
    ...
    - 打开Windows安全中心 - 病毒安全和防护 -  “病毒和威胁防护”管理设置 - 排除项添加 - 添加以下文件夹

```conf
  # Defender
  C:\Program Files\Windows Defender
  # Unity / UnityHub
  D:\ProgramFiles\UnityEditor
  D:\ProgramFiles\Unity Hub
  # github desktop
  C:\Users\Gumc\AppData\Local\GitHubDesktop\
  # vscode文件
  C:\Users\Gumc\.vscode
  D:\ProgramFiles\Microsoft VS Code
  # vscode remote tunnel 文件
  C:\Users\Gumc\.vscode-server
  # Dode
  C:\Users\Gumc\AppData\Roaming\Code
  C:\Users\Gumc\Desktop\projectXXX
  # NetEase
  D:\ProgramFiles\NetEase
```

  - 使用Process Monitor (ProcMon)查看实时防护在扫描哪些文件，并将其加入排除文件夹
    - [下载](https://docs.microsoft.com/en-us/sysinternals/downloads/procmon)
    - 以管理员身份运行
    - **点击菜单栏的** **Filter > Filter** - Add以下的Filter
      - Process Name + is + MsMpEng.exe + Include
      - Operation + is + ReadFile + Include
    - 点击Apply和OK
  - 清除缓存
    - **C:\Users\**[User Name]**AppData\Local\Temp 删除所有缓存。**
...
### 装机软件
  ...
  - 远程
    - ~~[Microsoft Remote Desktop](https://learn.microsoft.com/zh-cn/windows-server/remote/remote-desktop-services/clients/remote-desktop-clients) 弃用,不再更新~~
    - [UU远程](https://uuyc.163.com/) 可远程开机(不支持远程控制Mac)
    - VNC (Mac兼容不行，屏幕和鼠标有问题)
      - [UltraVNC](https://github.com/ultravnc/UltraVNC)
      - [TightVNC](https://www.tightvnc.com/)
      - [tigervnc](https://github.com/TigerVNC/tigervnc) 算最佳的
...
#### 办公软件
  ...
  - [PDF替换文字](https://pdf4me.com/find-and-replace/)

#### 管理软件

  - ~~[Microsoft Todo](https://todo.microsoft.com/) (已弃用，使用vscode+markdown的kanban插件替代)~~
...
#### 开发软件
  ...
  - [Free File Sync](https://freefilesync.org/)  不同项目之间贡献资源保持镜像同步
  - [Meld](https://github.com/GNOME/meld) 不同项目之间代码同步(可以像git一样对比)
...
#### 游戏开发软件
  ...
  - Xcode
  - [Cocos资源](https://github.com/fusijie/Cocos-Resource)
...
#### 美术软件
  ...
  - 3D
    ...
    - Sketchfab
      ...
      - [rigmodels](https://rigmodels.com/)和 [3dripper.com/library](http://3dripper.com/library/) 和 [Pack 3d Models](https://p3dm.ru/soft/rippers/)
  - Voxel
  ...
  - Minecraft
    ...
    - [mineway](https://www.realtimerendering.com/erich/minecraft/public/mineways/) minecraft地图转obj
  ...
  - Logo
    ...
    - [DragonBonesToSpineData](https://github.com/XpycT/DragonBoneToSpineData) dragonborn转spine
...
#### 系统软件
  ...
  - V2ray
    ...
    - Mac
      - [v2rayN](https://github.com/2dust/v2rayN/releases)
      - [~~v2rayU~~](https://github.com/yanue/V2rayU/tree/dev) 已弃用
    - Android
      - ~~[v2ray.vpn](https://github.com/bannedbook/v2ray.vpn/releases) 广告极多,但自带免费订阅~~
      - [v2rayNG](https://github.com/2dust/v2rayNG/releases)
  - [MultiPortProxy](https://github.com/shao-ye/MultiPortProxy) 基于v2rayN的多节点工具
  - Clash
  ...
  - [czkawka](https://github.com/qarmin/czkawka) 文件查重工具
  - [etcher](https://github.com/balena-io/etcher) / UltraISO / [rufus](https://github.com/pbatard/rufus) 刻录系统启动盘工具
  - [ccleaner](https://www.ccleaner.com/) 清除注册表等功能
  - [fastcopy](https://fastcopy.jp/) 解决拷贝文件时长度太长问题
...
#### AI工具
  ...
  - [huggingface](https://huggingface.co/) 机器学习界的github
  - 通用：Chat/Code/Image
  ...
  - Video、Images、3D、Audio
    - [Comfy](https://www.comfy.org/zh-cn/) 开源图片视频3D AI集合
  - 图片
    - [Qwen图像编辑](https://huggingface.co/Qwen/Qwen-Image-Edit)
    - [dreamstudio](https://beta.dreamstudio.ai/generate)
    - stable diffusion
    - [scenario](https://www.scenario.com/)
    - [InvokeAI](https://github.com/invoke-ai/InvokeAI)
    - [ICEdit](https://github.com/River-Zhang/ICEdit) 图片漫画化似乎不错
  - 模型
  ...
  - 视频
    ...
    - [X-Cut](https://github.com/Meigen-AI/X-Cut)
    - [Pixelle-Video](https://github.com/AIDC-AI/Pixelle-Video) AI 短视频引擎 | AI全自动短视频引擎
...
#### Decompile
  ...
  - Unity
    ...
    - ~~[不再维护] [AssetStudio](https://github.com/Perfare/AssetStudio) Unity提取资产~~
    - [AnimeStudio](https://github.com/Escartem/AnimeStudio)AssetStudio的维护版本
    ...
    - [UnityReverseEngine](https://github.com/IIIImmmyyy/UnityReverseEngine) 尚未发布，持续关注中
  - Cpp2IL
  - 使用CPP2IL
  ...
  - Godot
    ...
    - [gdsdecomp](https://github.com/bruvzg/gdsdecomp)  2.4.x及以下
    - [jscHookR](https://github.com/Mas0nShi/jscHookR) cocos-js
    - [cocoscreatorjscdecrypt_for_Android_Reverse](https://github.com/qriosa/cocoscreatorjscdecrypt_for_Android_Reverse)
  - Cocos

    - [cc-reverse](https://github.com/Crain99/cc-reverse)
  - [dnSpy](https://github.com/dnSpy/dnSpy) 与 ILSpy 类似，但允许调试甚至编辑程序集
  - [Il2CppDumper](https://github.com/Perfare/Il2CppDumper) 从使用 IL2CPP 构建的游戏中提取源代码
...
#### 下载网站
  ...
  - Android
    ...
    - [aptoide](https://en.aptoide.com/) Apk历史版本
    - [androidapks](https://androidapks.com/) Apk历史版本下载
    - [uptodown](https://www.uptodown.com/) Apk历史版本下载
    - [apkmonk](https://www.apkmonk.com/) Apk历史版本下载
    - [androeed](https://androeed.ru) 没有历史版本但能下载下架的游戏
...
---
    ...
    - [happymodapk](https://happymod.com/) Apk历史版本下载，但总是会下载平台app
...
#### 分析网站
  ...
  - [waybettergames](https://www.waybettergames.com/) 游戏和广告分析工具
...
#### 3D资源
  ...
  - [blender商店](https://www.blendswap.com/) blender商店
  - [rigmodels](https://rigmodels.com/) 免费3d模型网站
  - [poly.pizza](https://poly.pizza/) 似乎是GooglePoly的类似
...
#### 游戏美术
  ...
  - 微软[图片AI](https://microsoft.ai/news/introducing-mai-image-2)
...
### 其他
  ...
  - [身份证相片回执](https://hzl.rzzx.com.cn/upload)
  - [Youtube视频下载文本](https://downsub.com/)
...
（仅供教育和研究使用，请勿用于其他用途）
  ...
  - SSR配置
    ...
    - [new-pac](https://github.com/Alvin9999-newpac/new-pac/wiki/v2ray%E5%85%8D%E8%B4%B9%E8%B4%A6%E5%8F%B7)
  - V2ray配置

    - [new-pac](https://github.com/Alvin9999-newpac/fanqiang/wiki) / [永久地址](https://alvin9999.com/v2ray%E5%85%8D%E8%B4%B9%E8%B4%A6%E5%8F%B7/)
    ...
    - Google搜索：ssr 订阅 或  inurl:clash/proxies
  - V2ray路由设置
...
domain:donet5.com,
domain:coohex.com,
domain:guidedhacking.com,
domain:appodeal.com,
domain:aliyun.com,
domain:baidu.com,
domain:enjoyglobal.net,
domain:vungle.com,
...
domain:yuntongxun.com,
domain:rustdesk.com,
domain:et-framework.cn,
domain:hyperwallet.com
```
...
domain:unity3d.cn,
domain:unity3d.com,
domain:unitychina.cn,
domain:unitychina.com,
domain:vsassets.io,
domain:z.ai,
domain:zijieapi.com,
geosite:google,
...
### 从路由器(中继)设置
  ...
  - TP-Link：应用管理-无线桥接-扫描无线信号-选择需要桥接的主路由器-输入密码-获得从路由器IP例如：[http://192.168.10.168](http://192.168.10.168)
  - 小米：
...
### Unity配置
  ...
  - 设置保存代码不自动刷新
    ...
    - 如使用Visual Studio: 工具 - 选项 - 适用于Unity的工具 - 在保存时刷新Unity的AssetDatabase设置为False
  - 如何通过UnityHub安装Unity时总是失败：[绕过Unity CN访问国际版Unity](https://gumcstronger.github.io/2025/08/27/access_international_unity/)
  - 配置Unity缓存路径
  ...
  - 禁止自动清除控制台的所有日志
    ...
    - Unity - Console - Clear右边的下拉箭头 - 取消Clear on Build 和 Clear on Recompile
...
### Vscode配置
  ...
  - 插件
    ...
    - 必备
      ...
      - ~~Comment Translate / Code Translate~~ / 翻译(英汉词典)
      - Office Viewer(Markdown Editor)
      - Markdown Kanban (Markdown格式的看板可视化)
      - compareit 代码对比
    - 开发

      - ~~vscode-solution-explorer~~ 舍弃,C#开发环境例如C# Dev Kit或C# by ReSharpe都自带了
      - C# XML Documentation Comments
      - C# Dev Kit
        - C# Dev Ki t(依赖C# extension, ~~the IntelliCode for C# Dev Kit,~~ .NET Install Tool )
        - ~~IntelliCode for C# Dev Kit~~
        - 只能用于微软Vscode不能用于Vscode其他分支
      - C# by Resharper (vscode其他分支可用，例如Google Antigravity)
      - EditorConfig for VS Code
      - ~~[ShaderlabVSCode](https://assetstore.unity.com/packages/tools/utilities/shaderlabvscode-94653?aid=1011lGoJ&utm_campaign=unity_affiliate&utm_medium=affiliate&utm_source=partnerize-linkmaker) / [ShaderLabVscode](https://github.com/angus945/compute-shader-toolbox/tree/c90e604057ea46eac2a89879361d618d47836cf6/Assets/z_Plugin/ShaderlabVSCode/VSCodePlugin)~~
      - [Markdown Kanban](https://marketplace.visualstudio.com/items?itemName=holooooo.markdown-kanban) Markdown文件用看板功能显示
      - AI助手
        - Trae
        - Gemini Code Assist
        - ~~Tencent Code Buddy~~
...
```json
  {
      //----------------------- 界面与显示 (UI & Appearance) -----------------------
      "vscode-office.editorTheme": "Dracula", // 设置 Office 主题扩展的配色方案为 One Dark
      "workbench.editor.wrapTabs": true, // 当标签页选项卡超出屏幕宽度时自动换行显示
      "workbench.startupEditor": "none", // 禁用启动时的欢迎页，直接显示空白或上次关掉的文件
      "editor.minimap.enabled": false, // 禁用右侧代码缩略图（小地图），腾出更多显示空间
      ...
      "json.schemaDownload.enable": true, // 允许自动下载 JSON 架构文件，以提供代码补全和验证
      //----------------------- Git 设置 (Git Settings - 已禁用) --------------------
      "git.enabled": false, // 完全禁用内置的 Git 功能
      "git.autorefresh": false, // 禁用 Git 自动刷新
      "git.autofetch": false, // 禁用自动从远程仓库拉取更新
      "git.blame.statusBarItem.enabled": false, // 隐藏状态栏中的 Git Blame（代码作者）信息
      "git.detectWorktrees": false, // 禁用 Git 工作树检测
      //----------------------- .NET / C# 开发设置 (.NET & C#) ---------------------
      "omnisharp.useModernNet": false, // 强制 OmniSharp 使用桌面版 .NET Framework（对 Unity 项目兼容性更好）
      "dotnetAcquisitionExtension.enableTelemetry": false, // 禁用 .NET 安装扩展的遥测数据收集
      //----------------------- 编辑器行为与自动修复 (Editor Behavior) --------------
      "editor.formatOnSave": true, // 开启保存时自动格式化代码
      "editor.codeActionsOnSave": {
          "source.fixAll.csharp": "explicit" // 保存时显式执行所有可用的 C# 代码修复（如移除未使用的 using）
      },
      "files.trimTrailingWhitespace": true, // 保存时自动删除行尾多余的空格
      "files.insertFinalNewline": true, // 保存时确保文件末尾有一个空行（符合标准规范）
      //----------------------- 系统与遥测 (System & Telemetry) --------------------
      "telemetry.telemetryLevel": "off", // 完全关闭 VS Code 的全局遥测/数据上传
      "update.mode": "manual", // 将更新模式设为手动，避免在工作时自动下载更新
      //----------------------- 扩展程序专用配置 (Extension Specific) ---------------
      "antigravity.marketplaceGalleryItemURL": "https://marketplace.visualstudio.com/items", // 扩展市场项目链接地址
      "antigravity.marketplaceExtensionGalleryServiceURL": "https://marketplace.visualstudio.com/_apis/public/gallery", // 扩展市场 API 服务地址
      "vscode-office.viewAbsoluteLocal": true
  }

```

### Google Antigravity配置

  - [安装](https://antigravity.google/)
  - 修改插件市场配置
    - 打开侧边栏Extensions - Antigravity Settings - Editor
      - Marketplace Item URL填：[https://marketplace.visualstudio.com/items](https://marketplace.visualstudio.com/items)
      - MarketPlace Gallery URL填：[https://marketplace.visualstudio.com/_apis/public/gallery](https://marketplace.visualstudio.com/_apis/public/gallery)
  - 插件
    - 插件见Vscode插件
    - [Auto-Collapse Explorer](https://marketplace.visualstudio.com/_apis/public/gallery/publishers/lukegeneva/vsextensions/auto-collapse-explorer/latest/vspackage) 自动折叠
...
```bash
  # 一个整数 -1..9，表示默认压缩级别。-1 是 zlib 默认值。0表示不压缩，1..9 表示各种速度/大小权衡，9 表示最慢。如果设置，这将为其他压缩变量提供默认值，例如 core.looseCompression 和 pack.compression。
...
```
  ...
  [绕过Unity CN并访问国际版Unity Hub](https://gumcstronger.github.io/2025/08/27/access_international_unity/)

```bash
  # 以下配置方法已弃用，最新方法清参考Unity国际版的使用
  # 10808根据代理设置
...
```bash
  # 为整个系统启用长路径支持（需要管理员权限）
  git config --system core.longpaths true
  # 在 Windows 系统中启用长路径支持
  # 通过 PowerShell（管理员权限）,重启生效
  New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\FileSystem" -Name "LongPathsEnabled" -Value 1 -PropertyType DWORD -Force
```

  - 创建一个没有任何历史记录、完全“空”的分支
...
1. 使用Il2CppDumper [教程](http://jf.id.au/blog/modding-unity-il2cpp-games)
...
1. [frida-il2cpp-bridge](https://github.com/vfsfitvnm/frida-il2cpp-bridge) 的[教程](https://zhuanlan.zhihu.com/p/684035127)
...
### Python3 安装
  ...
  - 卸载
    - windows: 应用 - 卸载
  - 修改缓存路径
    - 配置 uv：点击“开始”搜索“编辑系统环境变量”，在“系统属性” > “高级” > “环境变量”中新建用户变量，将变量名设为 UV_CACHE_DIR，变量值设为 D:\ProgramFiles\python_cache\uv。
  - 配置 pip：在任意终端运行 pip config set global.cache-dir "D:\ProgramFiles\python_cache\pip"
