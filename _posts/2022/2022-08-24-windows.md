...
* [dnSpy](https://github.com/dnSpy/dnSpy) 反编译.Net dll
* Unity
  * [AssetStudio](https://github.com/Perfare/AssetStudio) Unity解包
  * [AssetRipper](https://github.com/AssetRipper/AssetRipper) Unity资源反序列化
* [NETReactorSlayer](https://github.com/SychicBoy/NETReactorSlayer) .Net 反混淆器和解包器
