...
| 入口                      | 额度                                                  | 是否值得试用 |
| ------------------------- | ----------------------------------------------------- | ------------ |
| VS Code 插件 (OAuth 登录) | Gemini 3 Flash 1,000 次                               | ✅           |
| Gemini CLI (OAuth 登录)   | Gemini 3 Flash 1,000 次                               | ✅           |
| Antigravity               | 信用点，[每日50点](https://gemini.google/subscriptions/) | ❌           |

## Codex/Claude (使用9Router接入所有AI，效果并不好)

备注：效果并不好，Claude、OpenAI和Gemini还有其他大模型之间的虽然能进行格式转化，但无法配合工具调用，例如claude code如果使用其他模型，会经常出现tool不存在。
有个大胆的想法，如果为Claude配置足够多的MCP作为tool，是否就可以使用第三方API了。待实现...

| 类型          | 名称                        | 是否接入                                       | Advance                            | Daily(稳定)                                                                                                                                                                                                                                            | Weekly | Monthly                | Free(不稳定)                                                                                                       | 免费额度说明                                                                                                              |
| ------------- | --------------------------- | ---------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ | ---------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| OAuth         | ~~claude code~~            | ❌                                             | ❌                                 | ❌                                                                                                                                                                                                                                                     | ❌     | ❌                     | ❌                                                                                                                 | 基本无，需要海外手机，不使用                                                                                              |
|               | ~~Antigravity~~            | ❌不合规                                       | ❌                                 | ❌                                                                                                                                                                                                                                                     | ❌     | ❌                     | ❌                                                                                                                 | 不符合谷歌要求，避免封号，不使用                                                                                          |
|               | OpenAI Codex                | ✅                                             | ✅ cx/gpt-5.3-codex               |                                                                                                                                                                                                                                                        |        |                        | ~~cx/gpt-5.1-codex-mini~~                                                                                         | [有限额度 GPT-5.3](https://chatgpt.com/zh-Hans-CN/pricing/)                                                                 |
...
| Free/Free试用 | Kiro（AWS亚马逊）           | ✅                                             | ✅kr/claude-sonnet-4.5             |                                                                                                                                                                                                                                                        |        | ✅kr/claude-sonnet-4.5 |                                                                                                                    | 新用户送500个credits,首月可用Claude Opus 4.6<br />[每月50 个 credits](https://kiro.dev/pricing/)                             |
|               | Qwen Code                   | ❌                                             |                                    |                                                                                                                                                                                                                                                        |        |                        |                                                                                                                    | ~~每日2000次请求 （中国大陆用户）~~[~~每日1000次（海外用户）~~](https://qwen-ai.com/qwen-code/#free-tier)免费额度100次每天 |
|               | Open Code                   | ✅                                             |                                    | ✅<br />oc/minimax-m2.5-free<br />~~oc/nemotron-3-super-free~~ 会挂起                                                                                                                                                                                 |        |                        |                                                                                                                    | 内置免费模型<br />不确定重置时间                                                                                          |
|               | Gemini CLI                  | ❌可能不合规                                   | ❌                                 | ❌                                                                                                                                                                                                                                                     | ❌     | ❌                     | ❌                                                                                                                 |                                                                                                                           |
|               | iFlow                       | ❌即将关闭                                     | ❌                                 | ❌                                                                                                                                                                                                                                                     | ❌     | ❌                     | ❌                                                                                                                 |                                                                                                                           |
|               | Open Router                 | ❌openrouter/free<br />但claude code使用会挂起 | ❌                                 | ❌                                                                                                                                                                                                                                                     | ❌     | ❌                     | ❌                                                                                                                 | 似乎在Claude Code中不能正确使用                                                                                           |
|               | Nvidia NIM                  | ✅                                             | -                                  | -                                                                                                                                                                                                                                                      | -      | -                      | ✅<br />nvidia/**minimaxai/minimax-m2.7**<br />nvidia/z-ai/glm5<br />nvidia/**qwen/qwen3.5-122b-a10b** | 没有额度限制，缺点是慢。<br />添加3个避免有的模型挂掉                                                                     |
|               | Ollama Cloud                | ✅                                             |                                    | ✅ollama/glm-5                                                                                                                                                                                                                                         |        |                        |                                                                                                                    | 每5小时重置一次<br />一周重置一次                                                                                         |
|               | Gemini                      | ❌Key只能在Gemini Cli中用                      | ~~gemini/gemini-3-flash-preview~~ | ~~gemini/gemini-3-flash-preview~~                                                                                                                                                                                                                     |        |                        |                                                                                                                    | ~~AI Studio后台显示:<br />Gemini 3 Flash 每日20次<br />Gemini 3 Flash Lite 每日500次~~                                   |
| API           | GLM Coding                  | ✅                                             |                                    |                                                                                                                                                                                                                                                        |        |                        | ✅glm/glm-4.7-flash                                                                                                | [GLM-4.7-Flash](https://docs.z.ai/guides/overview/pricing)永久免费，都不稳定                                                 |
|               | GLN(china)                  | ✅                                             |                                    |                                                                                                                                                                                                                                                        |        |                        | ✅glm-cn/glm-4.7-flash                                                                                             | [GLM-4.7-Flash](https://bigmodel.cn/pricing)永久免费，都不稳定                                                               |
|               | Groq                        | ✅                                             |                                    |                                                                                                                                                                                                                                                        |        |                        | ✅groq/openai/gpt-oss-120b                                                                                         | 每日14,400次请求<br />不支持VPN<br />据说当前免费,但似乎没有说明，先试用Free                                              |
|               | Mistral                     | ✅                                             |                                    |                                                                                                                                                                                                                                                        |        |                        | ✅mistral/codestral-latest                                                                                         | Experiment计划，模型免费，<br />但数据用于训练                                                                            |
|               | cerebras                    | ❌没有任何模型可用                             |                                    |                                                                                                                                                                                                                                                        |        |                        |                                                                                                                    | 每日14,400次请求<br />可能不支持VPN                                                                                       |
| Free          | modelscope.cn/API-Inference | ❌免费额度很少了                               |                                    | <br />~~modelscope/Qwen/Qwen3-Coder-480B-A35B-Instruct<br />modelscope/Qwen/Qwen3-Coder-30B-A3B-Instruct<br />modelscope/Qwen/Qwen3.5-397B-A17B<br />modelscope/Qwen/Qwen3-235B-A22B-Thinking-2507<br />modelscope/Qwen/Qwen3-Next-80B-A3B-Thinking~~ |        |                        |                                                                                                                    | ~~每日2000次，每个模型不超过500次~~<br />~~只有千问算力够，其他很慢~~<br />实际免费额度100次                            |
