...
layout:     post
title:      "Window常用配置"
subtitle:   " \"Github Page、Nodejs、Mongodb、Mysql\""
...
> 开发经常涉及一些安装和配置。Linux相关的这么多年都很完善了，Windows比较少涉及配置相关所以很少整理。这里整理下方便记录。  

## Windows装机配置
- Windows目录规范
  - D盘
    - D:\ProgramFiles   所有Windows软件安装在此处
    - D:\Pack           所有安装包等
    - D:\Data           所有资料/非Windows专属软件等
    - D:\Game           所有游戏
- Windows配置
    - 关闭快速启动
...
- [ShadowsocksR](https://github.com/shadowsocksr-backup/shadowsocksr-csharp/releases)
    - [ssr账号(偶尔失效)](https://github.com/Alvin9999/new-pac/wiki/ss%E5%85%8D%E8%B4%B9%E8%B4%A6%E5%8F%B7)
- [Clash](https://github.com/Fndroid/clash_for_windows_pkg)
    - [Clash汉化补丁](https://github.com/BoyceLig/Clash_Chinese_Patch)
    - [订阅(经常失效)](https://github.com/learnhard-cn/free_proxy_ss)
        - 可直接搜索“Clash订阅”